...
const Contact = () => {
    ...
    return (
        <main className="container my-5 p-5">
            <section className="contact-us p-4 p-md-5 d-flex flex-column flex-lg-row gap-4 align-items-center"
                style={{ minHeight: '75vh', backgroundColor: 'rgb(136 203 197)', borderRadius: '10px' }}>

                <div className="left w-100 w-lg-50 d-flex justify-content-center">
                    <img src="https://cdn.pixabay.com/photo/2022/03/01/08/11/call-center-7040784_960_720.png"
                        alt="Contact us"
                        style={{ maxWidth: '90%', height: 'auto', borderRadius: '10px' }} />
                </div>

                <div className="right w-100 w-lg-50 p-4 bg-white rounded"
                    style={{ boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>

                    <h2 className="fw-bold mb-4 text-center" style={{ color: 'var(--primary-color)' }}>CONTACT US</h2>
